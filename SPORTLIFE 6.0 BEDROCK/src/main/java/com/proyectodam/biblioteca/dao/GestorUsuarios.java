    ...
    public boolean autenticarUsuario(String nombre, String contraseña) {
        try (Connection connection = Conexion.getConnection()) {
            ...
            if (resultSet.next()) {
                ...
                usuarioActual = new RegistroUsuario(id, nombre, contraseña, correoElectronico, fechaNacimiento, String.valueOf(peso), String.valueOf(altura), frecuenciaEjercicio);
                return true;
            }
            return false;
