...
import com.proyectodam.biblioteca.dao.datosCrossfit;
...
public class VentanaCrossfit extends JFrame {
    ...
    public VentanaCrossfit() {
        ...
        lblTiempo = new JLabel("Tiempo restante: 0 segundos, Peso: " + peso + " kg, Repeticiones: 0");
...
class DatosCrossfit {
    ...
    public void guardarEjercicio(int usuarioId, String ejercicio, int peso, int repeticiones, int tiempoTotal) {
        ...
        System.out.println("Guardando ejercicio para el usuario " + usuarioId + ": " + ejercicio + ", Repeticiones: " + repeticiones + ", Peso: " + peso + " kg, Tiempo total: " + tiempoTotal + " segundos");
    }
    }
