...
public class RegistroUsuario {
    ...
    public RegistroUsuario(String nombre, String contraseña, String correoElectronico, String fechaDeNacimiento, String peso, String altura, String frecuenciaDeEjercicio) {
        this.nombre = nombre;
