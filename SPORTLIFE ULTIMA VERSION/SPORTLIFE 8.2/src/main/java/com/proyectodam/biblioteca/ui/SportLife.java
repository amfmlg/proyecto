...
import com.proyectodam.biblioteca.dto.Cardio;
...
public class SportLife extends JFrame {
    ...
    private void abrirVentanaPrincipal() {
        ...
        JPanel panelEstadisticas = createPanelEstadisticas(); // Se añade el panel de estadísticas
        ...
        tabbedPane.addTab("Estadisticas", panelEstadisticas); // Se añade el tab de estadisticas
    ...
    private JPanel createPanelEjercicios() {
        ...
        String[] tiposEjercicios = { "Cardio", "Mancuernas", "Estiramientos", "Yoga", "Crossfit" };
            ...
            btnEjercicio.addActionListener(e -> {
                ...
                switch (tipo) {
                    case "Mancuernas":
                        ...
                        break;
                    case "Crossfit":
                        VentanaCrossfit ventanaCrossfit = new VentanaCrossfit();
                        ventanaCrossfit.setVisible(true);
                        break;
                    case "Cardio":
                        VentanaCardio ventanaCardio = new VentanaCardio();
                        ventanaCardio.setVisible(true);
                        break;
                    case "Yoga":
                        VentanaYoga ventanaYoga = new VentanaYoga();
                        ventanaYoga.setVisible(true);
                        break;
                    case "Estiramientos":
                        VentanaEstiramientos ventanaEstiramientos = new VentanaEstiramientos();
                        ventanaEstiramientos.setVisible(true);
                        break;
                }
            });
 ...
 private JPanel createPanelEstadisticas() {
        ...
        if (usuario != null) {
            ...
            // Mostrar estadísticas de cardio si existen
List<Cardio> ejerciciosCardio = Cardio.getEjerciciosCardio();
    if (ejerciciosCardio != null && !ejerciciosCardio.isEmpty()) {
    textArea.append("\nEstadísticas de Cardio:\n");
    for (Cardio c : ejerciciosCardio) {
        textArea.append("Nombre: " + c.getNombre() + "\n");
        textArea.append("Duración: " + c.getDuracion() + " minutos\n");
        textArea.append("Distancia: " + c.getDuracion() + " km\n");
        textArea.append("\n");
    }
} else {
    textArea.append("No se encontraron registros de ejercicios de cardio.\n");
}


            // Mostrar estadísticas de mancuernas si existen
            List<mancuernas> ejerciciosMancuernas = mancuernas.getEjerciciosMancuernas();
    ...
    private JPanel createRegistroPanel() {
        ...
        JComboBox<String> comboFrecuenciaEjercicio = new
        JComboBox<>(opcionesFrecuencia);
        ...
        btnGuardar.addActionListener(e -> {
            ...
            RegistroUsuario usuario = new RegistroUsuario(nombre, contraseña, correo, fechaNacimiento, peso, altura, frecuenciaEjercicio);
